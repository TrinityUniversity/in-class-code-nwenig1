    ...
    handleAddClick(e){
      fetch(addRoute, {
          ...
          if(data){
             ...
             this.setState({taskMessage: "Failed to add task"}); 
          }
    ...
    handleDeleteClick(i){
        fetch(deleteRoute, {
            ...
            if(data){
                ...
                this.setState({taskMessage: "Failed to delete task"})
            }
...
/*
//if u don't need states, shorthand
function StatelessHello(props){
    return ce('div', null, `Hello ${props.toWhat}`); //no this when done as a function
}

class Hello extends React.Component {
    constructor(props){ //this is for states (mutable stuff)
        super(props); 
        this.state = { clickCount: 0}; 
    }
    render(){
        return ce('div', {onClick: (e) => this.clickHandler(e)},  null, `Hello ${this.props.toWhat} - click count ${this.state.clickCount}` );
    }
    clickHandler(e){
